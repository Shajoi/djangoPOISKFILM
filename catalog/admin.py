...
admin.site.register(Countrypet)
admin.site.register(AgePet)


class Klinikaadmin(admin.ModelAdmin):
    list_display = ('title','agepet','country','problemsummary','status')
    list_display_links = ('title','agepet','country','problemsummary','status')
